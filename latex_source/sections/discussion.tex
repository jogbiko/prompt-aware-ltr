...
environment uses a newer vLLM release than the original LTR framework's
target version, as documented in Section~\ref{sec:implementation}, which
limits direct numerical comparison to results reported under the original
framework's software stack.
